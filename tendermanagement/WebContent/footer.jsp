...
<html lang="en">
  <head>
    <link rel="shortcut icon" type="image/png" href="images/backgroundpic2.jpg">
...
<div class="navbar-inverse" style="color:white;padding:10px;margin-bottom:-20px;text-align: center;background-color:blue; border-radius: 0px">
                      <span style="font-size:1.2em;font-weight:bold;">Developed By</span>
</div><br/>
<div class="footer">    
  <div class="navbar navbar-inverse" style="border-radius: 0px ;margin-bottom:0px">
          <div class="container-fluid ">
              ...
              <br>
              <!-- Developer 1 Ms. Dhruvi Chotai-->
                <div class="col-md-3 col-xs-12 col-sm-3" >
                  <div class="col-md-5 col-xs-5 col-sm-5">
                    <img src="images/dhruvi.jpg" class="img-responsive img-circle pull-right" style="width:105px;height:130px;"alt="Dhruvi chotai Web Developer" title="Ms. Dhruvi Chotai"/>
                  </div>
                  <div class="col-md-7 col-xs-7 col-sm-7">
                    <div class="developers pull-left" style="font-weight: bold; color:white;text-align: center;">
                    <br/>
                    <span style="font-size: 1.7em; color:red">Ms. Dhruvi Chotai</span>
<!--                     <p><span>Web Developer</span></p>
 -->                    <p>20IT018</p>
  ...
  <div class="navbar-inverse" style="color:white;padding:05px;margin-bottom:-17px;text-align: center;background-color:green; border-radius: 0px">
                      <span style="float:left;padding-left: 6.5%">&copy; Copyright 2022</span><span style="padding-left:5%;">&nbsp; Tender Management Portal</span>
</div><br/>
